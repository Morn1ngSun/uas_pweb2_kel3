<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html">Bengkel Kita</a>
      </div>
      ...
      @if (Auth::user()->roles == 'admin')
        ...
        <li class="{{ (Request::url() === route('user.index')) ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('user.index') }}"><i class="ion-android-person"></i> <span>Daftar Pegawai</span></a>
        </li>
      ...
      <li class="menu-header">Bengkel Kita</li>
    ...
    <div class="modal-content">
      <form action="{{ route('transaction.report') }}" method="post">
        ...
        <div class="modal-footer bg-whitesmoke br">
          ...
          <button type="submit" class="btn btn-black">Proses</button>
        </div>
      </form>
    </div>
  </div>
